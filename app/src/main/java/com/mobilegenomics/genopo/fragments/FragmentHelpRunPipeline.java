    ...
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable final ViewGroup container,
        ...
        txt1.setText(
                "To run the pipeline configured through the modes STANDALONE, MINIT and DEMO you need to finally click RUN PIPELINE\n"
                        + "Once it's completed, If you want to save the logcat press WRITE LOG TO FILE. This will create a file called f5n.log.txt in mobile-genomics folder in your main storage\n");
